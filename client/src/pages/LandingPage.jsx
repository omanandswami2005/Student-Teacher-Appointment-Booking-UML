    ...
    <div>
      ...
      <main className="container mx-auto p-4">
        ...
        <div className="text-center mb-8 shadow-md mx-2 text-xl">
          ...
          <b>
            {' '}
            The Source Code, Documentation and to Contribute to the project{' '}
          </b>{' '}
          please visit the <b>Github page :</b>
          <br />
          <a
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mx-auto mb-8 text-xl max-w-2xl dark:bg-gray-800">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9734; Email:{' '}
                <span className="font-mono text-blue-600">admin@email.com</span>
              </p>
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9734; Password:{' '}
                <span className="font-mono text-blue-600">12345678</span>
              </p>
            </div>
            <div>
              <p className="font-medium">&bull;Teachers:</p>
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9734; Emails for teacher&apos;s
                login are available in the Admin Dashboard!
              </p>
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9734; Password is the same as
            ...
            <div>
              ...
              <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9734;Verify Email.</p>
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9734; Login, Use & Understand.
              </p>
              <p>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9734; Finally.... Delete
                Account Using Admin Dashboard!.
              </p>
            </div>
          </div>
              ...
              <div className="text-center mb-8 shadow-md mx-2 text-xl">
                ...
                <p className="text-left mb-8">
                  ...
                  &bull; Also we are using &nbsp; <b>
                    {' '}
                    THE FREE TIER&nbsp;{' '}
                  </b>of <b>MongoDB ATLAS </b>for storing data, Therefore{' '}
                  <b>All the data will be deleted after every 2 days🧹.</b>
                </p>
              </div>{' '}
            </li>
            <ul className="list-none space-y-2">
              <li className="flex items-center">
                ...
                <span>
                  Only Maximum <b> 10 Teachers </b> Can Exists In The System !
                  <br />
                  (4 [ Built In ] + 6 [ Can Be Added ] ){' '}
                </span>
              </li>
              <li className="flex items-center">
                <span className="mr-2">⚠️</span>
                <span>
                  Only Max <b>20 Students</b> Can Exists In The System !<br />
                  (1 [ Built In ] + 19 [ Can Be Added ] )
                </span>
              </li>
              <li className="flex items-center">
                <span className="mr-2">⚠️</span>
                <span>
                  Each <b> Appointment </b>Created In The System Will BE{' '}
                  <b> Deleted After 2 Days </b>!
                </span>
              </li>
              <li className="flex items-center">
                <span className="mr-2">⚠️</span>
                <span>
                  Every Logged In Session Will BE{' '}
                  <b> Expired (Auto Log Out) After 2 Hours</b> !
                </span>
              </li>
              ...
              <li className="flex items-center">
                <span className="mr-2">⚠️</span>
                <span>
                  And Finally... <br /> All The Data Will Be Deleted After Every
                  2 Days🧹.
                </span>
              </li>
            </ul>

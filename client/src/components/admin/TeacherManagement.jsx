    ...
    <>
      <div className="container mx-auto p-1">
        ...
        >
          ...
          <svg
            className="ml-2 w-6 h-6 text-gray-100 dark:text-gray-200"
            aria-hidden="true"
          ...
          <ul className="divide-y divide-gray-200 dark:divide-gray-700 w-full">
            ...
            {teachers?.map((teacher) => (
              <>
                <li
                  key={teacher.id}
                  className="mb-2 flex justify-between bg-gray-50 dark:bg-gray-900 dark:text-gray-200 p-4 rounded-lg overflow-x-auto w-full"
                >
                  <div className="mx-3">

...
const KeyMetrics = () => {
  ...
  return (
    <>
      <div>
        <h2 className="text-2xl font-semibold mt-5 mb-4 dark:text-gray-200">
          User & Status
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 gap-6">
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md flex justify-center flex-col">
            <h3 className="text-xl font-semibold mb-4 flex justify-center dark:text-gray-200">
              Total Number of Teachers
            </h3>
            <p className="text-3xl font-bold flex justify-center dark:text-gray-200">
          ...
          <div className="p-6 text-center bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <p className="text-3xl font-bold flex justify-center dark:text-gray-200">
              {counts.approvedStudentRegistration}
            </p>
          </div>
          <div className="p-6 text-center bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">
            ...
            <p className="text-3xl font-bold flex justify-center dark:text-gray-200">
              {counts.pendingStudentRegistration}
            </p>
          </div>
        </div>
      </div>
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 gap-6">
          <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 dark:text-gray-200 text-center">

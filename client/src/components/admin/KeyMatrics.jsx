      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 gap-6">
          ...
          <div className="p-6 text-center bg-white dark:bg-gray-800 rounded-lg shadow-md">
            ...
            <p className="text-3xl font-bold dark:text-gray-200">{counts.approvedStudentRegistration}</p>
          </div>
          <div className="p-6 text-center bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">Total Pending Registrations</h3>
            <p className="text-3xl font-bold dark:text-gray-200">{counts.pendingStudentRegistration}</p>
          </div>
        </div>
      </div>
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 gap-6">
          <button className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">Total Number of Appointments</h3>
            <p className="text-3xl font-bold dark:text-gray-200">{counts.totalAppointments}</p>
          </button>
          <button className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">Upcoming (Approved) Appointments</h3>
            <p className="text-3xl font-bold dark:text-gray-200">{counts.upcomingAppointments}</p>
          </button>
          <button className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">Pending Appointments</h3>
            <p className="text-3xl font-bold dark:text-gray-200">{counts.pendingAppointments}</p>
          </button>
          <button className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 dark:text-gray-200">Completed Appointments</h3>
            <p className="text-3xl font-bold dark:text-gray-200">{counts.completedAppointments}</p>
          </button>
          <button className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">

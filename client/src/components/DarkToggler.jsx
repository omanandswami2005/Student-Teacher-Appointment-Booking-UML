...
const DarkToggler = () => {
  ...
  return (
    <>
    <button onClick={toggleDarkMode} data-tooltip-target="tooltip-dark" className="p-2 rounded bg-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:border">
      {darkModeState ? <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
